...
public class RegisterDemoHardCoded {
	...
	public static void main(String[] args) {
		...
		//Parameterized all Input Values
				...
				String emailIDValue = "";
				String countryDrpDwnValue = "";
				String dateOfDemoValue = "";
				String hourValue = "";
				String minuteValue = "";
				String amPmValue = "";
				String mobileNumberValue = "";
				String seleniumWebdriverValue = "";
				String uftValue = "";
				String testNGValue = "";
				String coreJavaValue = "";
				String functionalTestingValue = "";
				String othersValue = "";
				String enterYourQueryValue = "";
				String successfulMessageText = "";
